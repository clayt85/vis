...
gulp.task('bundle', gulp.parallel('bundle-js', 'bundle-js-individual', 'bundle-css', 'bundle-css-individual', 'copy'));
...
gulp.task('watch', gulp.series(gulp.parallel(watchTasks), function () {
...
gulp.task('default', gulp.parallel('clean', 'bundle', 'minify'));
